...
/*!******************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/balloon-css/balloon.css ***!
  \******************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ref--6-1!./node_modules/postcss-loader/src??ref--6-2!./node_modules/sass-loader/lib/loader.js!./src/css/index.scss ***!
  \*****************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js??ref--6-1!../../node_modules/postcss-loader/src??ref--6-2!../../node_modules/sass-loader/lib/loader.js!./index.scss */ "./node_modules/css-loader/dist/cjs.js?!./node_modules/postcss-loader/src/index.js?!./node_modules/sass-loader/lib/loader.js!./src/css/index.scss");
...
function () {
  ...
  _createClass(Controller, [{
    ...
    value: function initReloadButton() {
      ...
      this.player.template.reloadButton.addEventListener('click', function () {
        _this3.player.switchVideo(_this3.player.options.video);

        _this3.player.toggle();
      });
    }
  }, {
    key: "initHighlights",
    value: function initHighlights() {
      ...
      this.player.on('durationchange', function () {
        if (_this4.player.video.duration !== 1 && _this4.player.video.duration !== Infinity) {
          if (_this4.player.options.highlight) {
            ...
            for (var i = 0; i < _this4.player.options.highlight.length; i++) {
              if (!_this4.player.options.highlight[i].text || !_this4.player.options.highlight[i].time) {
                continue;
              }

              var p = document.createElement('div');
              p.classList.add('dplayer-highlight');
              p.style.left = _this4.player.options.highlight[i].time / _this4.player.video.duration * 100 + '%';
              p.innerHTML = '<span class="dplayer-highlight-text">' + _this4.player.options.highlight[i].text + '</span>';

              _this4.player.template.playedBarWrap.insertBefore(p, _this4.player.template.playedBarTime);
            }
          }
        }
      });
    ...
    value: function initPlayedBar() {
      ...
      this.player.template.playedBarWrap.addEventListener(_utils__WEBPACK_IMPORTED_MODULE_0__["default"].nameMap.dragMove, function (e) {
        if (_this6.player.video.duration) {
          var px = _utils__WEBPACK_IMPORTED_MODULE_0__["default"].cumulativeOffset(_this6.player.template.playedBarWrap).left;
    ...
    value: function initFullButton() {
      ...
      this.player.template.videoWrap.addEventListener('dblclick', function () {
        _this7.player.fullScreen.toggle('browser');
      });
      this.player.template.controllerMask.addEventListener('dblclick', function () {
        _this7.player.fullScreen.toggle('browser');
      });
    }
  }, {
...
/* harmony import */ var _assets_reload_svg__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../assets/reload.svg */ "./src/assets/reload.svg");
/* harmony import */ var _assets_reload_svg__WEBPACK_IMPORTED_MODULE_16___default = /*#__PURE__*/__webpack_require__.n(_assets_reload_svg__WEBPACK_IMPORTED_MODULE_16__);
...
var Icons = {
  ...
  reload: _assets_reload_svg__WEBPACK_IMPORTED_MODULE_16___default.a
};
...
console.log('\n'.concat(" %c DPlayer v", "1.25.0", " ").concat("0f82d00", " %c http://dplayer.js.org ", '\n', '\n'), 'color: #fadfa3; background: #030307; padding:5px 0;', 'background: #fadfa3; padding:5px 0;');
...
function () {
  ...
  _createClass(InfoPanel, [{
    ...
    value: function update() {
      this.template.infoVersion.innerHTML = "v".concat("1.25.0", " ").concat("0f82d00");
...
function () {
  ...
  */
  function DPlayer(options) {
    ...
    this.options = Object(_options__WEBPACK_IMPORTED_MODULE_2__["default"])(options);
  ...
  _createClass(DPlayer, [{
    ...
    */
    ...
    value: function switchQuality(index) {
      ...
      this.video.pause(); // this.events.trigger('destroy');
